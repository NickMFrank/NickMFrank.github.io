...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      "service_o9gvv4t", 
      "template_zg98l6i", 
      {from_name: form.name, to_name: "Nick", from_email: form.email, to_email: "nickmhfrank@gmail.com", message: form.message}, 
      "sQQSDQNUCga19A5x3"
    ).then(() => {
      setLoading(false);
  ...
  return (
    <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
      ...
      >
        ...
        <div className="flex gap-2 justify-evenly mt-2 flex-wrap">
          <a
            href="mailto:nickmhfrank@gmail.com"
            className="text-white blue-yellow-gradient p-[1px] rounded-[40px] shadow-card"
          >
            <div className="bg-tertiary rounded-[40px] py-2 px-4 flex justify-evenly hover:bg-black-200">
